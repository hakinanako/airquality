...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3308/neu_air?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8");
        ...
        pc.setParent("com.neu.airquality");
        pc.setMapper("mapper");
